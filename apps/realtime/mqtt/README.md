...
参考文档：- [服务端EMQX安装文档](https://atengk.github.io/Ateng-Linux/work/docker/service/emqx/README)

### RabbitMQ

参考 [安装RabbitMQ](https://atengk.github.io/Ateng-Linux/work/service/rabbitmq/README) 文档，然后开启 MQTT 插件
